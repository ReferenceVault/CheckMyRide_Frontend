...
export default function StandardInspectionPage() {
  ...
  const calculateFormProgress = (): number => {
    ...
    const sections: Array<keyof typeof formData> = [
      'bodyCondition', 'lights', 'exteriorComponents', 'undercarriage', 'engine',
      'battery', 'fluidInspection', 'dashboardControls', 'windowsMirrors',
      'safetyEquipment', 'functionalTests', 'interiorCondition', 'drivingPerformance'
    ];
