...
const checklist = [
  'Mobile visit focusing on brakes, tires, suspension, and steering wear',
  'Battery health test with cold cranking amps and reserve capacity check',
  'Fluids top-off and contamination screening (oil, coolant, brake, washer)',
  'Safety systems verification: lights, wipers, seatbelts, warning icons',
  'Digital photos noting wear trends and recommended preventive service',
  'Predictive maintenance timeline tailored to your driving profile',
];
...
const highlights = [
  {
    ...
    description:
      'Designed for gig drivers, fleet operators, and busy commuters who need a recurring health check without downtime.',
  },
  {
    title: 'At your location',
    description:
      'We come to your driveway or lot—no need to coordinate service bays or drop-offs. Average visit time is 45 minutes.',
  },
  {
    title: 'Actionable reminders',
    description:
      'Receive a simple traffic-light plan that tells you what needs attention now, soon, or later, so you can plan service before breakdowns.',
  },
];
      ...
      <section className="relative overflow-hidden bg-[#0f172a] px-[12%] sm:px-[14%] lg:px-[15%] pt-14 pb-16 sm:pt-16 sm:pb-20">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <h1 className="mt-6 text-3xl sm:text-4xl lg:text-[2.9rem] font-bold leading-tight text-white">
            Keep your vehicle road-ready, week after week
          </h1>
          <p className="mt-5 text-lg sm:text-xl leading-relaxed text-white/80">
            A preventative inspection that slots into your schedule—capturing wear early, keeping earnings predictable, and preventing surprise downtime.
          </p>
        ...
        <div className="relative mx-auto max-w-6xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-base sm:text-lg leading-relaxed text-[#3a4a61]">
              Preventative insights that help you plan maintenance—not react to breakdowns.
            </p>
          </div>
