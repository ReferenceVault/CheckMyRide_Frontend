...
const checklist = [
  '50+ point mechanical and cosmetic checklist',
  'High-resolution photo gallery with annotations',
  'Severity tags (Green / Yellow / Red) for every finding',
  'Repair estimates with local market pricing guidance',
  'OBD scan of engine, transmission, ABS, and airbags',
  'VIN history snapshots and open recall review',
];
...
const highlights = [
  {
    ...
    description:
      'Our baseline inspection is built to surface the non-negotiables before you fall in love with the car. Every observation is paired with photos, technician notes, and a recommended action so you can make a confident decision.',
  },
  {
    title: 'Turnaround Time',
    description:
      'We inspect within 24 hours in most metro areas. The full digital report goes live within 6 hours of the appointment—accessible on desktop and mobile.',
  },
  {
    title: 'Ideal For',
    description:
      'Drivers who want a professional baseline review of a vehicle’s condition before committing to a purchase or deposit.',
  },
];

const addOns = [
  {
    name: 'Fluid Analysis Upgrade',
    desc: 'Lab-grade oil and coolant sampling to uncover internal engine wear or contamination.',
    price: '+$60',
  },
  {
    name: 'Underbody Imaging',
    desc: 'High-angle lift inspection with rust, leak, and suspension wear documentation.',
    price: '+$45',
  },
  {
    name: 'Negotiation Brief',
    desc: 'Inspector call plus offer strategy and estimated remediation costs.',
    price: '+$35',
  },
];
        ...
        <div className="relative mx-auto max-w-4xl">
          <div className="text-center">
            ...
            <h1 className="mt-6 text-3xl sm:text-4xl lg:text-[2.9rem] font-bold leading-tight text-white">
              Your Baseline for Buying with Confidence
            </h1>
            <p className="mt-5 text-lg sm:text-xl leading-relaxed text-white/80">
              Designed for everyday shoppers who want professional eyes on a vehicle before committing. We blend technician expertise, diagnostic tooling, and an easy-to-read digital report so you can negotiate—or walk away—with conviction.
            </p>
          </div>
        ...
        <div className="relative mx-auto max-w-6xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-base sm:text-lg leading-relaxed text-[#3a4a61]">
              A structured, transparent assessment sent straight to your inbox—with technician notes written in plain language.
            </p>
          </div>
