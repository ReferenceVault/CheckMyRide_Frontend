                ...
                {section.items.length > 0 && (
                  <div className="space-y-2">
                    {section.items.map((item) => {
                      const isActive = pathname === item.href || (item.href === '/admin/dashboard/bookings' && pathname?.includes('/bookings')) || (item.href === '/admin/dashboard/feedback' && pathname?.includes('/feedback'));
                      return (
                        <Link
                          key={item.href}
                          href={item.href}
